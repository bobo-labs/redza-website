    ...
    <main>
      ...
      <section className="proof-section section-pad" id="metodo">
        <div className="shell proof-grid">
          <div className="proof-image"><span className="proof-image-label">FLOTA / OPERACIÓN</span><Image src="/images/redza_fotos/optimized/redza-flota-camiones-operacion.webp" alt="Flota de camiones Redza frente a un centro de distribución" fill sizes="(max-width: 900px) 100vw, 42vw" className="proof-photo-main" /><span className="proof-photo-overlay">OPERACIÓN REAL<br /><strong>LISTOS PARA SALIR</strong></span><span className="proof-stamp">RZ / 2026</span></div>
