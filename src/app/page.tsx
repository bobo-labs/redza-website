      ...
      <header className="site-header">
        <div className="shell nav-wrap">
          <a href="#inicio" className="brand" aria-label="Redza, volver al inicio">
            <Image src="/images/redza branding/redza white lettering svg.svg" alt="Redza Transporte y Logística" width={2182} height={350} className="brand-logo brand-logo-new" />
          </a>
